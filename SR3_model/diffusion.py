...
class GaussianDiffusion(nn.Module):
    def __init__(self, model, steps, sample_steps):
        ...
        self.train_steps = steps # Batches? Indirect way of setting the batch size?
        self.sample_steps = sample_steps # Number of itarations to get from pure noise into model?
        self.model = model # What does this refer to?
    ...
    def _norm(self, img):
        return (img - 0.5) * 2.0 # why set values for norms?
